...
const serverList = [
  ...
  function updateServerElement(data, server, serverElement) {
	...
	mapImage.dataset.src = `${RESOURCES_URL}/maps/${server.game}/${serverMap}.png`;
	...
	if (data.numHumans > 0) {
	  ...
	  playersElement.classList.remove("tooltip");
	  playersElement.removeAttribute("title");
	}
	...
	const buttonsHtml = `
		  ...
		  <a href="#" class="serverButton serverInfo" draggable="false"><div class="info"></div></a>
	  `;
